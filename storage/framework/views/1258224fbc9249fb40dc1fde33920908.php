          ...
          <tr>
            <td style="padding:24px;">
              <h1 style="margin:0 0 8px 0; font-size:22px; line-height:1.3; color:#111827;">
                Hola, <?php echo new \Illuminate\Support\EncodedHtmlString($customer ?? 'Cliente'); ?> 👋
              </h1>
                  ...
                  <td style="padding:14px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px; color:#111827;">
                      <tr>
                        ...
                        <td style="padding:6px 0; font-weight:700;"><?php echo new \Illuminate\Support\EncodedHtmlString($customer ?? '-'); ?></td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0; color:#6b7280;">Email</td>
                        <td style="padding:6px 0; font-weight:700;"><?php echo new \Illuminate\Support\EncodedHtmlString($email ?? '-'); ?></td>
                      </tr>
                      <tr>
                        ...
                        <td style="padding:6px 0; font-weight:700;">
                          ...
                          ?>
                          <?php echo new \Illuminate\Support\EncodedHtmlString($pmLabel); ?>
                      ...
                      <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                          <td style="padding:12px 0; border-bottom:1px solid #f3f4f6;">
                            <div style="font-weight:700; color:#111827;"><?php echo new \Illuminate\Support\EncodedHtmlString($name); ?></div>
                          </td>
                          <td align="right" style="padding:12px 0; border-bottom:1px solid #f3f4f6;">
                            $<?php echo new \Illuminate\Support\EncodedHtmlString(number_format($price, 2)); ?>

                          </td>
                          <td align="right" style="padding:12px 0; border-bottom:1px solid #f3f4f6;">
                            <?php echo new \Illuminate\Support\EncodedHtmlString($qty); ?>

                          </td>
                          <td align="right" style="padding:12px 0; border-bottom:1px solid #f3f4f6; font-weight:700;">
                            $<?php echo new \Illuminate\Support\EncodedHtmlString(number_format($subtotal, 2)); ?>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top:12px;">
                      ...
                      <tr>
                        <td align="right" style="padding-top:6px; font-size:20px; font-weight:800; color:#111827;">
                          $<?php echo new \Illuminate\Support\EncodedHtmlString(number_format($total, 2)); ?>
          ...
          <tr>
            <td style="padding:16px 24px; background:#f9fafb; border-top:1px solid #e5e7eb;">
              <div style="font-size:12px; color:#6b7280; line-height:1.6;">
                © <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> Mi App. Todos los derechos reservados.
              </div>
            </td>
          </tr>
        </table>
...
<?php /**PATH C:\Users\super\Herd\practica1backend\resources\views/email-template.blade.php ENDPATH**/ ?>